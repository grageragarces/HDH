#!/usr/bin/env python3
"""
Brute Force Cut Optimization Comparison - V3 (FULLY CORRECTED)
...
def brute_force_node_level(
    ...
    with tqdm(total=total_partitions, desc="  🔍 Evaluating partitions", 
        ...
        for assignment in product(range(k), repeat=n_total):
            ...
            # Count cuts directly on partition_sets
...
def run_comparison_experiment(
    ...
    csv_path = OUTPUT_DIR / f'comparison_results_10_{method.lower()}_updated.csv'
...
def main():
    ...
    print("\n" + "="*70)
    print(f"BRUTE-FORCE COMPARISON V3 - FULLY CORRECTED ({method})")
    print("="*70)
    print(f"V3 CHANGES:")
