...
![HDH symbol legend.\label{fig:hdh_legend}](docs/img/HDHobjects.png){ width=20% }
...
![Circuit to HDH mapping table.\label{fig:circuit_mappings}](docs/img/circuitmappings.png){ width=30% }
